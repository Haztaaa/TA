...
class Kriteria extends CI_Controller
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('message', '<text class="alert alert-success"> Tambah Data Berhasil, Silahakan melakukan perhitungan bobot</text>');
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('message', '<text class="alert alert-success"> Ubah Data Berhasil</text>');
            redirect(site_url('kriteria'));
        }
    }
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('message', '<text class="alert alert-success"> Hapus Data Berhasil</text>');
            redirect(site_url('kriteria'));
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('kriteria'));
